...
{
  "$end", "error", "$undefined", "NUM", "SUB", "PLUS", "MUL", "DIV",
...
yyreduce:
  ...
  case 2:
#line 25 "task1.y"
                         {(yyval.no)=(yyvsp[-1].no); printf("Infix: ");
                            infix((yyvsp[-1].no));
                            printf("\n");
                            printf("Postfix: ");
                            postfix((yyvsp[-1].no));
                            printf("\n\n");
                            printf("Answer: %d",evaluate((yyvsp[-1].no)));
                            exit(1);}
#line 1329 "y.tab.c"
    break;
...
#line 1359 "y.tab.c"
  ...
  case 8:
#line 38 "task1.y"
                        {(yyval.no)=makeLeafNode((yyvsp[0].val));}
#line 1365 "y.tab.c"
    break;
