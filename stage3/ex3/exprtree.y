...
stmt : READ '(' ID ')' ';'                            { $$ = createTree(0, 0, NULL, NODE_READ, $3, NULL); }
     ...
     | DO slist WHILE '(' expr ')' ';'                { $$ = createTree(0, 0, NULL, NODE_DO_WHILE, $5, $2); }     
     | REPEAT slist UNTIL '(' expr ')' ';'            { $$ = createTree(0, 0, NULL, NODE_REPEAT_UNTIL, $5, $2); } 
     | BREAK ';'                                      { $$ = createTree(0, 0, NULL, NODE_BREAK, NULL, NULL); }
     | CONTINUE ';'                                   { $$ = createTree(0, 0, NULL, NODE_CONTINUE, NULL, NULL); }
     ;
